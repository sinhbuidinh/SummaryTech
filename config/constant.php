...
defined('DATE_FORMAT_YMD_HIS') or define('DATE_FORMAT_YMD_HIS', 'Y-m-d H:i:s');
defined('DATE_FORMAT_YMD_T_HI') or define('DATE_FORMAT_YMD_T_HI', 'Y-m-d\TH:i');
defined('DATE_FORMAT_YMD_DOT') or define('DATE_FORMAT_YMD_DOT', 'Y.m.d');
defined('FORMAT_DATETIME_LOCAL') or define('FORMAT_DATETIME_LOCAL', 'Y-m-d\TH:i');
